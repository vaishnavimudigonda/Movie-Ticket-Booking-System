 ...
 * Populates DB with admin user, sample movies, and shows
 */
...
async function seed() {
  try {
    ...
    await Promise.all([User.deleteMany(), Movie.deleteMany(), Show.deleteMany()]);
    console.log('Cleared existing data');

    await User.create({ name: 'Admin User', email: 'admin@movieclick.com', password: 'admin123', role: 'admin' });
    console.log('Admin created  -> admin@movieclick.com / admin123');

    await User.create({ name: 'John Doe', email: 'user@movieclick.com', password: 'user123', role: 'user' });
    console.log('User created   -> user@movieclick.com / user123');
    ...
    console.log(`Created ${showDocs.length} shows`);

    console.log('\n Database seeded successfully!');
    console.log('Movies   : ' + createdMovies.length);
    console.log('Shows    : ' + showDocs.length);
    console.log('Timings  : 11:30 AM | 2:00 PM | 4:00 PM | 6:30 PM | 10:00 PM');
    console.log('Theaters : Prasads IMAX, PVP Cinemas, PVR Cinemas, AMB Cinemas, Cinepolis, Asian Sudarshan, SPI Sathyam');
    console.log('Admin    : admin@movieclick.com / admin123');
    console.log('User     : user@movieclick.com / user123');
    process.exit(0);
  } catch (err) {
